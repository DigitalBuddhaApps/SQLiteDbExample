package com.bigkidsapps.sqliteexample;
...
public class ContactDbHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_TABLE = "create table " + ContactContract.ContactEntry
            .TABLE_NAME + "(" + ContactContract.ContactEntry.CONTACT_ID + " number, " +
            ContactContract.ContactEntry.NAME + " text," + ContactContract.ContactEntry.EMAIL + "" +
            " text);";

    public static final String DROP_TABLE = "drop table if exists " + ContactContract
